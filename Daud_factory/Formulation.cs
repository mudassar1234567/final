    ...
    public partial class Formulation : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (comboBox1.Text == "2inch13ft,1.7kg")
            {
                ...
                cmd.ExecuteNonQuery();
                cmd.CommandText = "update raw_material set  quantity=" + uvtax + " where name= 'UVtax'";
                cmd.ExecuteNonQuery();
                ...
                cmd.ExecuteNonQuery();
                cmd.CommandText = "update raw_material set  quantity=" + chock + " where name= 'Chowk powder'";
                cmd.ExecuteNonQuery();
                double total = (qnt * 1.7);
                cmd.CommandText = "INSERT INTO production_inventory (name, quantity, date, weight) values ('" + comboBox1.Text + "','" + textBox1.Text + "','" + dateTimePicker1.Text + "','" + total + "')";
                cmd.ExecuteNonQuery();
